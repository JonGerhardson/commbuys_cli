...
```bash
git clone <repo-url> && cd commbuys_cli
```

### Really quick start

Move `agent/skills/commbuys.md` to wherever you keep your Claude Code / AI agent skill files and tell your bot to find you some juicy government contracts.
